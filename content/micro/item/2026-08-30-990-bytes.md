...
Yet some of the submissions are quite interesting, with complex animated backgrounds or interactive features.

I decided to make my own for fun. It's simple, but you can find it [here](@/card.md)! The 'stand-out' feature is the DVD bouncer. Sort of lame, but I didn't want to sacrifice the utility of the page in pursuit of a tiny page.

## The Content
The actual HTML itself is only 760B, but there is a FAT http header on top of that due to my hosting being through GitLab pages.
...
All of our intentional mistakes do not show to end users at all!
