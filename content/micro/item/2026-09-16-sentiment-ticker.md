...
+++
If you look at the [homepage](@/micro/_index.md), you may notice the new feature
...
to render some simple charts using special syntax like so:
...
I used a Python script to read my files and extract the sentiment form them using [vaderSentiment](https://vadersentiment.readthedocs.io/en/latest/),
